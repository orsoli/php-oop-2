...
/**
 * This is the Toy class which extends from the Product class.
 * This class specifies that every Toy object has the size and material,
...
class Toy extends Product{
     ...
     * Creates a Toy object with parameters for img,title,category,stock,price and description.
     *
